...
class GeminiAdapter(BaseIDEAdapter):
    ...
    ide_type = IDEType.GEMINI
    display_name = "Gemini CLI"
    description = "Gemini CLI with skills support"

    supports_skill = True
    skill_file_path = ".gemini/skills/vibecollab/SKILL.md"

    supports_mcp = False
    mcp_config_path = None

    def get_skill_content(self) -> str:
        """获取 Gemini Skill 文件内容（Markdown + YAML Frontmatter 格式）。"""
        return """---
