...
|-----|------|---------|------------|
| **S** | 战略决策 | 协议设计、核心概念 | 必须人工确认，记录决策理由 |
| **A** | 架构决策 | Schema结构、扩展机制 | 人工Review，可异步确认 |
| **B** | 实现决策 | 具体实现方案 | AI 提出建议，人工可快速确认或默认通过 |
| **C** | 细节决策 | 命名、格式 | AI 自主决策，事后可调整 |
...
| v0.1.1 | 2026-01-20 | 补充遗漏章节，完善协议完整性 |
